...
function CoffeeSlot(props) {
  ...
  return (
    ...
    >
      <div
        className={styles.coffeeInfo + ` ${hovered ? styles.infoHovered : ""}`}
      >
        <div>
          <div className={styles.coffeeName}>{props.coffee.name}</div>
          <div className={styles.coffeeOrigin}>{props.coffee.country}</div>
        </div>
        ...
        <div className={hovered ? styles.buttonDivHover : styles.buttonDiv}>
          <Button
            ...
            onClick={() =>
              history.push("coffee/" + formatURL(props.coffee.name))
            }
          >
            more info
          </Button>
          <Button
            buttonClass="primary"
            onClick={() => {
              cartContext.addToCart(props.coffee, 1);
            }}
          >
            add to cart
          </Button>
