...
// Modal.setAppElement('.' + styles.adminPage);
// Modal.setAppElement(document.querySelector('.' + styles.adminPage));
...
function Admin() {
  ...
  return (
    <div className={styles.adminPage}>
      ...
      >
        <h1>Add coffee</h1>
        <form action="/api/coffee" method="POST">
          <label htmlFor="name">Coffee name:</label>
          <input type="text" id="name" name="name" className="form-element" required />
          <label htmlFor="continent">Continent:</label>
          <select name="continent" id="continent" className="form-element">
          ...
          <select id="country" name="country" className="form-element">
            <option value="N/A">N/A (Blended)</option>
          ...
          <select id="process" name="process" className="form-element">
            <option value="N/A">N/A (Blended)</option>
          ...
          <input type="number" min="0" max="30" step="0.01" id="price" name="price" className="form-element" required /> 
          <label htmlFor="roast">Roast:</label>
          <select id="roast" name="roast" className="form-element">
          ...
          <input type="text" id="description" name="description" className="form-element" required />
          <label htmlFor="descriptor1">Flavour Descriptor 1:</label>
          <input type="text" id="descriptor1" name="descriptor1" className="form-element" required />
          <label htmlFor="descriptor2">Flavour Descriptor 2:</label>
          <input type="text" id="descriptor2" name="descriptor2" className="form-element" />
          <label htmlFor="descriptor3">Flavour Descriptor 3:</label>
          <input type="text" id="descriptor3" name="descriptor3" className="form-element" />
          <input type="submit" value="save" className="form-element" />
        </form>
      </Modal>
      <Header />
      <div className={styles.adminBlock}>
        ...
        <div className={styles.buttonDiv}>
          <button onClick={openModal}>add coffee</button>
        </div>
      </div>
      <Footer />
    </div>
